...
func _000001_add_received_messages_tableDownDbSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_add_received_messages_table.down.db.sql", size: 38, mode: os.FileMode(436), modTime: time.Unix(1554444385, 0)}
...
func _000001_add_received_messages_tableUpDbSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000001_add_received_messages_table.up.db.sql", size: 106, mode: os.FileMode(436), modTime: time.Unix(1554707817, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
